...
<div class="row" style="background-color: white; margin-top: -15px; height: 55px">
        <div class="bred">
            <p style="font-family: Arial; font-size: 20px; color: steelblue; margin-left: 20px; margin-top: 15px">Quadras</p> 
        </div>
    </div>
    <br>
    <a href="{{route('quadras.create')}}" class="btn btn-primary" 
        role="button" style="margin-left: 85%"><i class="fa fa-plus"></i> Nova Quadra</a> 
@stop
